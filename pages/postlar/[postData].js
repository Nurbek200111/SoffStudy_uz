...
import data from "../../util/aducationData"
...
const PostDetails = () => {
    ...
    useEffect(() => {
        setBlogPost(data.find((data) => data.id == postData));
    }, [postData]);
                                    ...
                                    <div className="col-xl-10 col-lg-12">
                                        <div className="row align-items-end mt-50">
                                            <div className="col-lg-7 mb-20">
                                                <div className="d-inline-block position-relative">
                                                    <h1 className="color-white mb-20 color-linear wow animate__animated animate__fadeIn">{data[postData-1].Title}</h1><span className="btn btn-linear-small btn-number-arts">{data[postData-1].data.length} articles</span>
                                                </div>
                                        ...
                                        <div className="mt-50 mb-50">
                                            <div className="row mt-50 mb-10">
                                                ...
                                                {
                                                    data[postData-1].data.map((item, i) => {
                                                            ...
                                                            <div className="col-lg-4" key={i}>
                                                                <div className="card-blog-1 hover-up wow animate__animated animate__fadeIn">
                                                                    ...
                                                                    <div className="card-info">
                                                                        <div className="row">
                                                                            <div className="col-7"><Link className="color-gray-700 text-sm" href="/blog-archive">{item.key_words[0]}</Link></div>
                                                                        ...
                                                                        <div className="row align-items-center mt-25">
                                                                            <div className="col-7">
                                                                                <Link href={`/autor_post/`}>
                                                                                    <div className="box-author">
                                                                                        <img src={`${item.auhtor_img}`} alt="Genz" />
                                                                                        <div className="author-info">
                                                                                            <h6 className="color-gray-700">{item.author_name}</h6><span className="color-gray-700 text-sm">{item.date}</span>
                                                                                        </div>
                                                                                    </div>
                                                                                </Link>
                                                                            </div>
                                                                            <div className="col-5 text-end"><Link className="color-gray-500 text-sm" href="/single-sidebar"><span>Batafsil</span></Link></div>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </div>
