...
import aducations from "../util/aducationData";

export default function Home() {
    console.log(aducations);
    return (
        <>
            <Head>
                                ...
                                <div className="row align-items-end mt-50">
                                    <div className="col-lg-7 mb-20">
                                        <div className="d-inline-block position-relative">
                                            <h1 className="color-white mb-20 color-linear wow animate__animated animate__fadeIn">Yonalishlar</h1><span className="btn btn-linear-small btn-number-arts">{aducations.length} ta </span>
                                        </div>
                                        <p className="color-gray-500 text-base wow animate__animated animate__fadeIn">Biz bilan sifatli bilim olishga intiling</p>
                                    </div>
                                            ...
                                            <div className="col-lg-4"  key={i}>
                                                <div className="card-blog-1 hover-up wow animate__animated animate__fadeIn">
                                                    ...
                                                    <div className="card-info">
                                                            ...
                                                            <div className="col-7">
                                                                {
                                                                    item.keywords.map(item => (
                                                                      <>
                                                                        <Link className="color-gray-700 text-sm" href="/blog-archive">#{item} </Link>
                                                                      </>
                                                                    ))
                                                                }
                                                            </div>
                                                        ...
                                                        <p className="color-gray-500 mt-15">{item.decritoin}</p>
                                                        <div className="row align-items-center mt-25">
                                                            <div className="col-7">
                                                                <div className="box-author">
                                                                    <div className="author-info">
                                                                        <h6 className="color-gray-700">{item.Title}</h6><span className="color-gray-700 text-sm">O`quv markazlari: {item.data.length} </span>
                                                                    </div>
                                                                </div>
                                                            </div>
